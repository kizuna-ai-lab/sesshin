...
describe('ensureHubRunning', () => {
  it('returns immediately when /api/v1/health responds 200', async () => {
  ...
  it('spawns when /api/v1/health unreachable; resolves once new instance answers', async () => {
    ...
    // Stub binary listens on the chosen port and returns 200 on /api/v1/health.
